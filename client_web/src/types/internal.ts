...
export const SQLUser = {
  encode(message: SQLUser, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.prefferedLanguage !== "") {
      writer.uint32(146).string(message.prefferedLanguage);
    }
    return writer;
  },
...
export const User = {
  encode(message: User, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.prefferedLanguage !== "") {
      writer.uint32(154).string(message.prefferedLanguage);
    }
    return writer;
  },
...
export const Post = {
  encode(message: Post, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.threadStart !== "0") {
      writer.uint32(120).int64(message.threadStart);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.replyToID = longToString(reader.int64() as Long);
          continue;
        case 5:
          if (tag !== 42) {
            break;
        ...
        case 6:
          ...
          message.quotedID = longToString(reader.int64() as Long);
          continue;
        case 7:
          if (tag !== 58) {
            break;
        ...
        case 15:
          ...
          message.threadStart = longToString(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
