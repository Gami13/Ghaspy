...
export const ResponseError = {
	...
	create<I extends Exact<DeepPartial<ResponseError>, I>>(
		base?: I,
	): ResponseError {
...
export const ResponseSetDisplayName = {
	encode(
		message: ResponseSetDisplayName,
		writer: _m0.Writer = _m0.Writer.create(),
	): _m0.Writer {
		if (message.message !== "") {
			writer.uint32(10).string(message.message);
	...
	create<I extends Exact<DeepPartial<ResponseSetDisplayName>, I>>(
		base?: I,
	): ResponseSetDisplayName {
		return ResponseSetDisplayName.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseSetDisplayName>, I>>(
		object: I,
	): ResponseSetDisplayName {
		const message = createBaseResponseSetDisplayName();
		message.message = object.message ?? "";
...
export const ResponseSetBio = {
	...
	create<I extends Exact<DeepPartial<ResponseSetBio>, I>>(
		base?: I,
	): ResponseSetBio {
		return ResponseSetBio.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseSetBio>, I>>(
		object: I,
	): ResponseSetBio {
		const message = createBaseResponseSetBio();
		message.message = object.message ?? "";
...
export const ResponseToggleFollowersPublic = {
	...
	create<I extends Exact<DeepPartial<ResponseToggleFollowersPublic>, I>>(
		base?: I,
	): ResponseToggleFollowersPublic {
...
export const ResponseToggleFollowingPublic = {
	...
	create<I extends Exact<DeepPartial<ResponseToggleFollowingPublic>, I>>(
		base?: I,
	): ResponseToggleFollowingPublic {
...
export const ResponseTogglePostsPublic = {
	...
	create<I extends Exact<DeepPartial<ResponseTogglePostsPublic>, I>>(
		base?: I,
	): ResponseTogglePostsPublic {
		return ResponseTogglePostsPublic.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseTogglePostsPublic>, I>>(
		object: I,
	): ResponseTogglePostsPublic {
		const message = createBaseResponseTogglePostsPublic();
		message.message = object.message ?? "";
...
export const ResponseToggleLikesPublic = {
	...
	create<I extends Exact<DeepPartial<ResponseToggleLikesPublic>, I>>(
		base?: I,
	): ResponseToggleLikesPublic {
		return ResponseToggleLikesPublic.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseToggleLikesPublic>, I>>(
		object: I,
	): ResponseToggleLikesPublic {
		const message = createBaseResponseToggleLikesPublic();
		message.message = object.message ?? "";
...
export const ResponseSetAvatar = {
	...
	create<I extends Exact<DeepPartial<ResponseSetAvatar>, I>>(
		base?: I,
	): ResponseSetAvatar {
		return ResponseSetAvatar.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseSetAvatar>, I>>(
		object: I,
	): ResponseSetAvatar {
		const message = createBaseResponseSetAvatar();
		message.message = object.message ?? "";
...
export const ResponseSetBanner = {
	...
	create<I extends Exact<DeepPartial<ResponseSetBanner>, I>>(
		base?: I,
	): ResponseSetBanner {
		return ResponseSetBanner.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseSetBanner>, I>>(
		object: I,
	): ResponseSetBanner {
		const message = createBaseResponseSetBanner();
		message.message = object.message ?? "";
...
export const ResponseLogInUser = {
	...
	create<I extends Exact<DeepPartial<ResponseLogInUser>, I>>(
		base?: I,
	): ResponseLogInUser {
		return ResponseLogInUser.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseLogInUser>, I>>(
		object: I,
	): ResponseLogInUser {
		const message = createBaseResponseLogInUser();
...
export const ResponseGetProfile = {
	...
	create<I extends Exact<DeepPartial<ResponseGetProfile>, I>>(
		base?: I,
	): ResponseGetProfile {
		return ResponseGetProfile.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseGetProfile>, I>>(
		object: I,
	): ResponseGetProfile {
		const message = createBaseResponseGetProfile();
		message.profile =
...
export const ResponseSignUpUserError = {
	...
	create<I extends Exact<DeepPartial<ResponseSignUpUserError>, I>>(
		base?: I,
	): ResponseSignUpUserError {
		return ResponseSignUpUserError.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseSignUpUserError>, I>>(
		object: I,
	): ResponseSignUpUserError {
		const message = createBaseResponseSignUpUserError();
...
export const ResponseToggleBookmark = {
	...
	create<I extends Exact<DeepPartial<ResponseToggleBookmark>, I>>(
		base?: I,
	): ResponseToggleBookmark {
		return ResponseToggleBookmark.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseToggleBookmark>, I>>(
		object: I,
	): ResponseToggleBookmark {
		const message = createBaseResponseToggleBookmark();
		message.message = object.message ?? "";
...
export const ResponseToggleLike = {
	...
	create<I extends Exact<DeepPartial<ResponseToggleLike>, I>>(
		base?: I,
	): ResponseToggleLike {
		return ResponseToggleLike.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseToggleLike>, I>>(
		object: I,
	): ResponseToggleLike {
		const message = createBaseResponseToggleLike();
		message.message = object.message ?? "";
...
export const ResponseToggleFollow = {
	...
	create<I extends Exact<DeepPartial<ResponseToggleFollow>, I>>(
		base?: I,
	): ResponseToggleFollow {
		return ResponseToggleFollow.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseToggleFollow>, I>>(
		object: I,
	): ResponseToggleFollow {
		const message = createBaseResponseToggleFollow();
		message.message = object.message ?? "";
...
export const ResponseDeletePost = {
	...
	create<I extends Exact<DeepPartial<ResponseDeletePost>, I>>(
		base?: I,
	): ResponseDeletePost {
		return ResponseDeletePost.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseDeletePost>, I>>(
		object: I,
	): ResponseDeletePost {
		const message = createBaseResponseDeletePost();
		message.message = object.message ?? "";
...
export const ResponseAddPost = {
	...
	create<I extends Exact<DeepPartial<ResponseAddPost>, I>>(
		base?: I,
	): ResponseAddPost {
		return ResponseAddPost.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseAddPost>, I>>(
		object: I,
	): ResponseAddPost {
		const message = createBaseResponseAddPost();
		message.message = object.message ?? "";
...
export const ResponseSignUpUser = {
	...
	create<I extends Exact<DeepPartial<ResponseSignUpUser>, I>>(
		base?: I,
	): ResponseSignUpUser {
		return ResponseSignUpUser.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseSignUpUser>, I>>(
		object: I,
	): ResponseSignUpUser {
		const message = createBaseResponseSignUpUser();
		message.message = object.message ?? "";
...
export const ResponseLogOutUser = {
	...
	create<I extends Exact<DeepPartial<ResponseLogOutUser>, I>>(
		base?: I,
	): ResponseLogOutUser {
		return ResponseLogOutUser.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseLogOutUser>, I>>(
		object: I,
	): ResponseLogOutUser {
		const message = createBaseResponseLogOutUser();
		message.message = object.message ?? "";
...
export const ResponseValidateUser = {
	...
	create<I extends Exact<DeepPartial<ResponseValidateUser>, I>>(
		base?: I,
	): ResponseValidateUser {
		return ResponseValidateUser.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ResponseValidateUser>, I>>(
		object: I,
	): ResponseValidateUser {
		const message = createBaseResponseValidateUser();
		message.message = object.message ?? "";
...
export const ResponseGetPostsChronologically = {
	...
	create<I extends Exact<DeepPartial<ResponseGetPostsChronologically>, I>>(
		base?: I,
	): ResponseGetPostsChronologically {
...
export const ResponseGetPostsChronologicallyByUser = {
	...
	create<
		I extends Exact<DeepPartial<ResponseGetPostsChronologicallyByUser>, I>,
	>(base?: I): ResponseGetPostsChronologicallyByUser {
		return ResponseGetPostsChronologicallyByUser.fromPartial(
			base ?? ({} as any),
		);
	},
	fromPartial<
		I extends Exact<DeepPartial<ResponseGetPostsChronologicallyByUser>, I>,
	>(object: I): ResponseGetPostsChronologicallyByUser {
		const message = createBaseResponseGetPostsChronologicallyByUser();
		message.posts = object.posts?.map((e) => Post.fromPartial(e)) || [];
		message.message = object.message ?? "";
		message.pageNumber = object.pageNumber ?? 0;
